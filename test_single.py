...
def main(args):
    ...
    target_name = f'test_data/results/images/{args.img_fp.split("/")[-1][:-4]}'
    ...
    print('inference: {}ms'.format(elapse))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-f', '--img_fp', type=str, default='test_data/inputs/images/up.png')
